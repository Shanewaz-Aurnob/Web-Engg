...
const Login = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if (role === 'teacher' && id === '5008' && password === 'teacher@08') {
            ...
            setErrorMessage('Invalid credentials or role'); // Set error message
        }
    };

    return (
        <div className='h-screen flex justify-center items-center'>
            <div className='w-[28rem] shadow-gray-400 lg:shadow-[10px_10px_20px_0_rgba(0,0,0,0.5)] shadow-[10px_10px_10px_0_rgba(0,0,0,0.9)]'>
